...
page {
    ...
    headerData{
        ...
        3.value = <link href="fileadmin/templates/css/style2.css" rel="stylesheet"/>
        ...
        130 {
            ...
            2 = TEXT
            2.value = <link rel="stylesheet" href="fileadmin/templates/css/style.css">
            
            # template-rvwg-01
            3 = TEXT
            3.value = <link rel="stylesheet" href="fileadmin/templates/css/style-rvwg-01.css">
            3.value = <link href="fileadmin/templates/css/bootstrap.min.css" rel="stylesheet" />
            3.value = <link href="fileadmin/templates/css/material-kit.css" rel="stylesheet"/>
            3.value = <link href="fileadmin/templates/css/style.css" rel="stylesheet"/>
            3.value = <link href="fileadmin/templates/css/style2.css" rel="stylesheet"/>
            3.value = <link href="fileadmin/templates/css/animate.min.css" rel="stylesheet"/>
        }
        ...
        140 {
            ...
            # template-rvwg-01
            3 = TEXT
            3.value = <link rel="stylesheet" href="fileadmin/templates/css/customizer/home-pages-customizer.css">
        }
        ...
        150 {
            ...
            # template-rvwg-01
            3 = TEXT
            3.value = <link rel="stylesheet" href="fileadmin/templates/css/customizer/pages-pages-customizer.css">
        }
